...
namespace RenSharp
{
	public interface class IRenSharpGameModeEventClass : public IRenSharpGameModeClass, public IRenSharpEventClass
	{

	};

	public ref class RenSharpGameModeEventClass abstract : public IRenSharpGameModeEventClass
	{
		private:
			bool disposedResources;
			bool destroyPointer;
			IntPtr renSharpGameModeEventClassPointer;
